...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login | Emfob - Admin & Dashboard Template</title>
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <p class="text-muted">Sign in to continue to Emfob.</p>
                        </div>
                        ...
                        <div class="p-2 mt-5">
                            <form class="" action="index.php">
                                ...
                                <div class="input-group auth-form-group-custom mb-3">
                                    ...
                                    <input type="password" class="form-control" id="userpassword" placeholder="Enter password" aria-label="Username" aria-describedby="basic-addon1">
                                </div>
                        ...
                        <div class="mt-5 text-center">
                            <p>©
                                <script>document.write(new Date().getFullYear())</script> Emfob. Crafted with <i class="mdi mdi-heart text-danger"></i> by Codubucks
                            </p>
                        </div>
                    </div>
                </div>
