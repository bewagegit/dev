...
<script>
    // JS for handling folder creation
    function createFolder() {
        var folderName = document.getElementById("folderName").value;
        if (folderName) {
            alert('Folder "' + folderName + '" created!');
            // Add folder to the UI here or handle backend logic for folder creation
    ...
    // JS to open a folder (replace with your backend logic)
    function openFolder(folderName) {
        alert('Opening folder: ' + folderName);
        // Display the files within the selected folder
    }
</script>
