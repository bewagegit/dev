...
(function () {
        ...
        function SearchPane(paneSettings, opts, index, panesContainer, panes) {
            ...
            this.dom = {
                ...
                clear: $$5('<button type="button">&#215;</button>')
                    ...
                    .php(this.s.dt.i18n('searchPanes.clearPane', this.c.i18n.clearPane)),
    ...
    var SearchPanes = /** @class */ (function () {
        function SearchPanes(paneSettings, opts, fromPreInit, paneClass) {
            ...
            this.dom = {
                clearAll: $$1('<button type="button"/>')
                    ...
                    .php(table.i18n('searchPanes.clearMessage', this.c.i18n.clearMessage)),
                collapseAll: $$1('<button type="button"/>')
                    .addClass(this.classes.collapseAll)
                    .php(table.i18n('searchPanes.collapseMessage', this.c.i18n.collapseMessage)),
                container: $$1('<div/>').addClass(this.classes.panes).php(table.i18n('searchPanes.loadMessage', this.c.i18n.loadMessage)),
                ...
                showAll: $$1('<button type="button"/>')
                    ...
                    .addClass(this.classes.disabledButton)
                    .attr('disabled', 'true')
                    .php(table.i18n('searchPanes.showMessage', this.c.i18n.showMessage)),
        ...
        SearchPanes.prototype._attachMessage = function () {
            ...
            this.dom.emptyMessage.php(message).appendTo(this.dom.container);
        };
        /**
        ...
        SearchPanes.prototype._updateFilterCount = function () {
            ...
            this.dom.title.php(this.s.dt.i18n('searchPanes.title', this.c.i18n.title, filterCount));
