...
<head>
    ...
    <meta charset="utf-8" />
    <title>Widget-Chart | Emfob - Admin & Dashboard Template</title>
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Widget-Chart</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Elements</a></li>
                                    <li class="breadcrumb-item active">Widget-Chart</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                        ...
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="col-xl-5">
                                                <div class="hstack gap-2">
                                                    <div>
                                                        <h6 class="fs-12 mb-0"><i class="fas fa-circle text-primary fs-10 me-1"></i>Laptop</h6>
                                                    </div>
                                                    <div>
                                                        <h6 class="fs-12 mb-0"><i class="fas fa-circle text-danger fs-10 me-1"></i>Keyboard</h6>
                                                    </div>
                                                    <div>
                                                        <h6 class="fs-12 mb-0"><i class="fas fa-circle text-success fs-10 me-1"></i>Mouse</h6>
                                                    </div>
                                                    <div>
                                                        <h6 class="fs-12 mb-0"><i class="fas fa-circle text-warning fs-10 me-1"></i>Desktop</h6>
                                                    </div>
                                                    <div>
                                                        <h6 class="fs-12 mb-0"><i class="fas fa-circle text-info fs-10 me-1"></i>Mobile</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- end card-body -->
                                    <div class="card-body">
                                        <div id="global_sales" data-colors='["--bs-primary", "--bs-danger"]' class="apex-charts" dir="ltr"></div>
                                    </div>
                                </div>
                                <!-- end card -->
                            </div>
                    ...
                    <div class="col-xxl-4">
                        <div class="card" style="background: url('assets/images/widgets-chart-shape.png'); background-repeat: no-repeat; background-position: right bottom;">
                            <div class="bg-overlay bg-success-subtle opacity-75"></div>
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-7">
                                        <div id="total_cov" data-colors='["--bs-primary", "--bs-danger", "--bs-info", "--bs-success"]' class="apex-charts" dir="ltr"></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="sales_dynamics" data-colors='["--bs-primary", "--bs-success", "--bs-warning", "--bs-danger"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div>
                        <!-- end col -->
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-addon">
                                    <div class="nav nav-lines card-nav" id="card1-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="card1-month-tab" data-bs-toggle="tab" href="#card1-month" aria-selected="true" role="tab">Last Month</a>
                                        <a class="nav-item nav-link" id="card1-time-tab" data-bs-toggle="tab" href="#card1-time" aria-selected="false" role="tab" tabindex="-1">All Time</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane fade active show" id="card1-month" role="tabpanel" aria-labelledby="card1-month-tab">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="rich-list-item p-0">
                                                                <div class="rich-list-content">
                                                                    <h4 class="rich-list-title">Rhona Davidson</h4><span class="rich-list-subtitle">SEO Specialist</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>Edinburgh</td>
                                                        <td style="max-width: 8rem">
                                                            <div class="" data-colors='["--bs-success", "--bs-transparent"]' dir="ltr" id="coin1_sparkline_charts"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="rich-list-item p-0">
                                                                <div class="rich-list-content">
                                                                    <h4 class="rich-list-title">Brielle Williamson</h4><span class="rich-list-subtitle">System Architect</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>London</td>
                                                        <td style="max-width: 8rem">
                                                            <div class="" data-colors='["--bs-info"]' dir="ltr" id="coin2_sparkline_charts"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="rich-list-item p-0">
                                                                <div class="rich-list-content">
                                                                    <h4 class="rich-list-title">Garrett Winters</h4><span class="rich-list-subtitle">Accountant</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>Tokyo</td>
                                                        <td style="max-width: 8rem">
                                                            <div class="" data-colors='["--bs-danger"]' dir="ltr" id="coin3_sparkline_charts"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="rich-list-item p-0">
                                                                <div class="rich-list-content">
                                                                    <h4 class="rich-list-title">Airi Satou</h4><span class="rich-list-subtitle">Senior Developer</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>London</td>
                                                        <td style="max-width: 8rem">
                                                            <div class="" data-colors='["--bs-warning"]' dir="ltr" id="coin4_sparkline_charts"></div>
                                                        </td>
                                            ...
                                            <table class="table table-borderless table-striped table-hover text-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Edinburgh</td>
                                                        <td style="max-width: 8rem">
                                                            <div class="" data-colors='["--bs-danger"]' dir="ltr" id="coin8_sparkline_charts"></div>
                                                        </td>
                                                        <td><span class="badge badge-label-success">Good</span></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>London</td>
                                                        <td style="max-width: 8rem">
                                                            <div class="" data-colors='["--bs-warning"]' dir="ltr" id="coin5_sparkline_charts"></div>
                                                        </td>
                                                        <td><span class="badge badge-label-info">Standard</span></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>Tokyo</td>
                                                        <td style="max-width: 8rem">
                                                            <div class="" data-colors='["--bs-success"]' dir="ltr" id="coin6_sparkline_charts"></div>
                                                        </td>
                                                        <td><span class="badge badge-label-primary">Excelent</span></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>London</td>
                                                        <td style="max-width: 8rem">
                                                            <div class="" data-colors='["--bs-info"]' dir="ltr" id="coin7_sparkline_charts"></div>
                                                        </td>
                                                        <td><span class="badge badge-label-danger">Bad</span></td>
                                                    </tr>
                                                </tbody>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="">
                                    <div id="support_requests" data-colors='["--bs-success", "--bs-warning", "--bs-danger"]' class="apex-charts" dir="ltr"></div>
                                    <div class="d-flex justify-content-around">
                                        <span class="text-muted"><i class="marker marker-dot text-primary"></i> 20% Margin </span><span class="text-muted"><i class="marker marker-dot text-success"></i> 70% Profit </span>
                    ...
                    <div class="col-xl-4">
                        <div class="card mb-0">
                            ...
                            <div class="card-body">
                                ...
                                <div id="multiple_heatmap" data-colors='["--bs-primary", "--bs-secondary", "--bs-success", "--bs-info", "--bs-warning", "--bs-danger", "--bs-dark"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <div class="card mb-0">
                            ...
                            <div class="card-body">
                                <div id="efficiency" data-colors='["--bs-primary","--bs-success"]' class="apex-charts" dir="ltr"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4">
