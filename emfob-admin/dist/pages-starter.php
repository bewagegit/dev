    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="container mt-5">
                <h1 class="text-center">Available Skill Exams</h1>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <p>Test your knowledge of JavaScript fundamentals and basic programming concepts.</p>
                                <p class="text-muted">Duration: 30 minutes</p>
                                <p class="text-muted">Pass Mark: 70%</p>
                                <a href="javascript_exam.php" class="btn btn-success">Attempt Exam</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <p>Evaluate your understanding of HTML and CSS basics in this short exam.</p>
                                <p class="text-muted">Duration: 20 minutes</p>
                                <p class="text-muted">Pass Mark: 75%</p>
                                <a href="html_css_exam.php" class="btn btn-success">Attempt Exam</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <p>Assess your verbal and written communication skills through this exam.</p>
                                <p class="text-muted">Duration: 15 minutes</p>
                                <p class="text-muted">Pass Mark: 80%</p>
                                <a href="communication_exam.php" class="btn btn-success">Attempt Exam</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Uncomment this section if there are no available exams -->
                    <!-- 
