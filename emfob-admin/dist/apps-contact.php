...
<head>
    ...
    <meta charset="utf-8" />
    <title>Contact | Emfob - Admin & Dashboard Template</title>
                                    ...
                                    <ul class="verti-timeline list-unstyled">
                                        <li class="active mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div>
                                                        <h5 class="fs-15 mb-1"><a href="javascript: void(0);" class="text-body">Back end Developer</a></h5>
                                        ...
                                        <li class="mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div>
                                                        <h5 class="fs-15 mb-1"><a href="javascript: void(0);" class="text-body">Front end Developer</a></h5>
                                        ...
                                        <li class="">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div>
                                                        <h5 class="fs-15 mb-1"><a href="javascript: void(0);" class="text-body">UI /UX Designer</a></h5>
