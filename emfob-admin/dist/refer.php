        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Referal Bonus</h4>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="referral-card text-center p-4">
                            <h2 class="mb-4">Invite and Earn</h2>
                            ...
                            <div class="points-section mt-4">
                                ...
                                <div class="row text-start mt-3">
                                    <div class="col-12 col-md-4 mb-3">
                                        <div class="point-item d-flex align-items-center">
                                            <i class="fas fa-coins fa-2x text-warning me-3"></i>
                                            <span>Earn 10 points per referral</span>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-4 mb-3">
                                        <div class="point-item d-flex align-items-center">
                                            <i class="fas fa-gift fa-2x text-success me-3"></i>
                                            <span>Bonus 50 points after 5 referrals</span>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-4 mb-3">
                                        <div class="point-item d-flex align-items-center">
