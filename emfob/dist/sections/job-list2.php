                        ...
                        <div class="job-box card mt-4">
                            ...
                            <div class="p-4">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <div>
                                            <span class="badge bg-success-subtle text-success fs-13 mt-1">Full
                                                Time</span>
                            ...
                            <div class="p-3 bg-light">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div>
                                            <p class="text-muted mb-0"><span class="text-dark">Experience
                                                    :</span> 1
                                                - 2 years</p>
                                        </div>
                                    </div>
                        ...
                        <div class="job-box bookmark-post card mt-4">
                            ...
                            <div class="p-4">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <div>
                                            <span class="badge bg-danger-subtle text-danger fs-13 mt-1">Part
                                                Time</span>
                                            <span class="badge bg-info-subtle  text-info fs-13 mt-1">Private</span>
                            ...
                            <div class="p-4">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-2 mb-md-0">
                                            <h5 class="fs-18 mb-1"><a href="job-details.html" class="text-dark">Digital
                                                    Marketing
                                                    Manager</a></h5>
                                            <p class="text-muted fs-14 mb-0">Emfob Technology Pvt.Ltd</p>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-2">
                                        <div>
                                            <span
                                                class="badge bg-primary-subtle text-primary fs-13 mt-1">Freelancer</span>
                                            <span class="badge bg-info-subtle text-info  fs-13 mt-1">Private</span>
                                        </div>
                                    </div>
                                    <!--end col-->
                        ...
                        <div class="job-box card mt-4">
                            ...
                            <div class="p-4">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <div>
                                            <span class="badge bg-success-subtle text-success fs-13 mt">Full
                                                Time</span>
                                            <span class="badge bg-warning-subtle text-warning fs-13 mt-1">Urgent</span>
                                        </div>
                                    </div>
