                        ...
                        <div class="blog-post">
                            <div class="row">
                                <div class="col-lg-6 mb-4">
                                    <div class="card blog-grid-box p-2">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-inline d-flex justify-content-between mb-3">
                                                <li class="list-inline-item">
                                                    <p class="text-muted mb-0"><a href="blog-author.html"
                                                            class="text-muted fw-medium">Alice Mellor</a> - Aug 08, 2021
                                                    </p>
                                                </li>
                                                <li class="list-inline-item">
                                            ...
                                            <a href="blog-details.php" class="primary-link">
                                            ...
                                            <p class="text-muted">Intrinsically incubate intuitive opportunities and
                                                ...
                                                technology.</p>
                                            <div>
                                                <a href="blog-details.php" class="form-text text-primary">Read More <i
                                    ...
                                    <div class="card blog-grid-box p-2">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-inline d-flex justify-content-between mb-3">
                                                <li class="list-inline-item">
                                                    <p class="text-muted mb-0"><a href="blog-author.html"
                                                            class="text-muted fw-medium">Kiera Finch</a> - July 23, 2021
                                                    </p>
                                                </li>
                                                <li class="list-inline-item">
                                            ...
                                            <a href="blog-details.php" class="primary-link">
                                                <h6 class="fs-17">How To Increase Trade Show Traffic</h6>
                                            </a>
                                            <p class="text-muted">Intrinsically incubate intuitive opportunities and
                                                real-time potentialities Appropriately communicate one-to-one
                                                technology.</p>
                                    ...
                                    <div class="card blog-grid-box p-2">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-inline d-flex justify-content-between mb-3">
                                                <li class="list-inline-item">
                                                    <p class="text-muted mb-0"><a href="blog-author.html"
                                                            class="text-muted fw-medium">Toby Lees</a> - July 11, 2021
                                                    </p>
                                                </li>
                                                <li class="list-inline-item">
                                            ...
                                            <a href="blog-details.php" class="primary-link">
                                                <h6 class="fs-17">How apps is changing the IT world</h6>
                                            </a>
                                            <p class="text-muted">Intrinsically incubate intuitive opportunities and
                                                real-time potentialities Appropriately communicate one-to-one
                                                technology.</p>
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="card blog-grid-box p-2">
                                        <div class="overflow-hidden">
                                            <img src="assets/images/blog/img-07.jpg" alt="" class="img-fluid">
                                        </div>
                                        <div class="card-body">
                                            <ul class="list-inline d-flex justify-content-between mb-3">
                                                <li class="list-inline-item">
                                                    <p class="text-muted mb-0"><a href="blog-author.html"
                                                            class="text-muted fw-medium">Dominic Potter</a> - June 19,
                                                        2021</p>
                                                </li>
                                                <li class="list-inline-item">
                                            ...
                                            <a href="blog-details.php" class="primary-link">
                                                <h6 class="fs-17">Design your apps in your own way</h6>
                                            </a>
                                            <p class="text-muted">Intrinsically incubate intuitive opportunities and
                                                real-time potentialities Appropriately communicate one-to-one
                                                technology.</p>
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="card blog-grid-box p-2">
                                        <div class="overflow-hidden">
                                            <img src="assets/images/blog/img-08.jpg" alt="" class="img-fluid">
                                        </div>
                                        <div class="card-body">
                                            <ul class="list-inline d-flex justify-content-between mb-3">
                                                <li class="list-inline-item">
                                                    <p class="text-muted mb-0"><a href="blog-author.html"
                                                            class="text-muted fw-medium">Leon Davey</a> - June 04, 2021
                                                    </p>
                                                </li>
                                                <li class="list-inline-item">
                                            ...
                                            <a href="blog-details.php" class="primary-link">
                                                <h6 class="fs-17">How to get creative in your work</h6>
                                            </a>
                                            <p class="text-muted">Intrinsically incubate intuitive opportunities and
                                                real-time potentialities Appropriately communicate one-to-one
                                                technology.</p>
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="card blog-grid-box p-2">
                                        <div class="overflow-hidden">
                                            <img src="assets/images/blog/img-09.jpg" alt="" class="img-fluid">
                                        </div>
                                        <div class="card-body">
                                            <ul class="list-inline d-flex justify-content-between mb-3">
                                                <li class="list-inline-item">
                                                    <p class="text-muted mb-0"><a href="blog-author.html"
                                                            class="text-muted fw-medium">Harvey Bird</a> - Feb 28, 2021
                                                    </p>
                                                </li>
                                                <li class="list-inline-item">
                                            ...
                                            <a href="blog-details.php" class="primary-link">
                                                <h6 class="fs-17">What planning process needs ?</h6>
                                            </a>
                                            <p class="text-muted">Intrinsically incubate intuitive opportunities and
                                                real-time potentialities Appropriately communicate one-to-one
                                                technology.</p>
                                    ...
                                    <div class="card blog-grid-box p-2">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-inline d-flex justify-content-between mb-3">
                                                <li class="list-inline-item">
                                                    <p class="text-muted mb-0"><a href="blog-author.html"
                                                            class="text-muted fw-medium">Harvey Bird</a> - Feb 21, 2021
                                                    </p>
                                                </li>
                                                <li class="list-inline-item">
                                            ...
                                            <a href="blog-details.php" class="primary-link">
                                                <h6 class="fs-17">How to become a best sale marketer in a year!</h6>
                                            </a>
                                            <p class="text-muted">Intrinsically incubate intuitive opportunities and
                                                real-time potentialities Appropriately communicate one-to-one
                                                technology.</p>
                                    ...
                                    <div class="card blog-grid-box p-2">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-inline d-flex justify-content-between mb-3">
                                                <li class="list-inline-item">
                                                    <p class="text-muted mb-0"><a href="blog-author.html"
                                                            class="text-muted fw-medium">Harvey Bird</a> - Feb 09, 2021
                                                    </p>
                                                </li>
                                                <li class="list-inline-item">
                                                    <p class="text-muted mb-0"><i class="mdi mdi-eye"></i> 244</p>
                                                </li>
                                            </ul>
                                            <a href="blog-details.php" class="primary-link">
                                                <h6 class="fs-17">A day in the of a professional fashion designer</h6>
                                            </a>
                                            <p class="text-muted">Intrinsically incubate intuitive opportunities and
                                                real-time potentialities Appropriately communicate one-to-one
                                                technology.</p>
                                ...
                                <ul class="widget-popular-post list-unstyled my-4">
                                    <li class="d-flex mb-3 align-items-center pb-3 border-bottom">
                                        ...
                                        <div class="flex-grow-1 text-truncate ms-3">
                                            <a href="blog-details.php" class="text-dark">The evolution of landing page
                                                creativity</a>
                                    ...
                                    <li class="d-flex mb-3 align-items-center pb-3 border-bottom">
                                        <img src="assets/images/blog/img-02.jpg" alt=""
                                            class="widget-popular-post-img rounded" />
                                        <div class="flex-grow-1 text-truncate ms-3"><a href="blog-details.php"
