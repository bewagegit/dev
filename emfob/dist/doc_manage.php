...
<div class="main-content">
    ...
    <h2 class="text-center mb-4">Manage Your Documents</h2>

    <!-- Upload Section -->
    <div class="upload-section mb-4" onclick="document.getElementById('fileInput').click()">
        <i class="fas fa-cloud-upload-alt fa-3x text-primary"></i>
        <h5 class="mt-3">Click to Upload Documents</h5>
        <p class="text-muted">Supported formats: PDF, DOCX, JPG, PNG</p>
    ...
    <div class="row">
            ...
            <div class="document-card">
                <div class="doc-header">
                    <div class="d-flex align-items-center">
                        <i class="fas fa-file-pdf doc-icon text-danger me-3"></i>
                        <div>
                            <h5 class="mb-0">Resume.pdf</h5>
                            <p class="text-muted mb-1">Uploaded: Oct 22, 2024</p>
                        </div>
                    </div>
                </div>
                <hr>
        ...
        <!-- Add more document cards below -->
        <div class="col-md-4">
            <div class="document-card">
                <div class="doc-header">
                    <div class="d-flex align-items-center">
                        <i class="fas fa-file-word doc-icon text-primary me-3"></i>
                        <div>
                            <h5 class="mb-0">CoverLetter.docx</h5>
                            <p class="text-muted mb-1">Uploaded: Oct 20, 2024</p>
                        </div>
                    </div>
                </div>
                <hr>
        ...
        <div class="col-md-4">
            <div class="document-card">
                <div class="doc-header">
                    <div class="d-flex align-items-center">
                        <i class="fas fa-image doc-icon text-success me-3"></i>
                        <div>
                            <h5 class="mb-0">ProfilePhoto.jpg</h5>
                            <p class="text-muted mb-1">Uploaded: Oct 18, 2024</p>
                        </div>
                    </div>
                </div>
                <hr>
