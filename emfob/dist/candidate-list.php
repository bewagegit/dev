...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Candidate List | Emfob</title>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="candidate-list-images">
                                                            <a href="javascript:void(0)"><img src="assets/images/user/img-01.jpg" alt="" class="avatar-md img-thumbnail rounded-circle"></a>
                                                        </div>
                                                    </div><!--end col-->
                                                    
                                                    <div class="col-lg-5">
                                                        <div class="candidate-list-content mt-3 mt-lg-0">
                                                            <h5 class="fs-19 mb-0"><a href="candidate-details.html" class="primary-link">Charles Dickens</a> <span class="badge bg-success ms-1"><i class="mdi mdi-star align-middle"></i> 4.8</span></h5>
                                        ...
                                        <div class="candidate-list-box bookmark-post card mt-4">
                                            <div class="card-body p-4">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="candidate-list-images">
                                                            <a href="javascript:void(0)"><img src="assets/images/user/img-02.jpg" alt="" class="avatar-md img-thumbnail rounded-circle"></a>
                                                        </div>
                                                    </div><!--end col-->
                                                    <div class="col-lg-5">
                                                        <div class="candidate-list-content mt-3 mt-lg-0">
                                                            <h5 class="fs-19 mb-0"><a href="candidate-details.html" class="primary-link">Gabriel Palmer</a> <span class="badge bg-warning ms-1"><i class="mdi mdi-star align-middle"></i> 3.4</span></h5>
                                        ...
                                        <div class="candidate-list-box card mt-4">
                                            <div class="card-body p-4">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="candidate-list-images">
                                                            <a href="javascript:void(0)"><img src="assets/images/user/img-03.jpg" alt="" class="avatar-md img-thumbnail rounded-circle"></a>
                                                        </div>
                                                    </div><!--end col-->
                                                    <div class="col-lg-5">
                                                        <div class="candidate-list-content mt-3 mt-lg-0">
                                                            <h5 class="fs-19 mb-0"><a href="candidate-details.html" class="primary-link">Rebecca Swartz</a> <span class="badge bg-success ms-1"><i class="mdi mdi-star align-middle"></i> 4.3</span></h5>
                                        ...
                                        <div class="candidate-list-box bookmark-post card mt-4">
                                            <div class="card-body p-4">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="candidate-list-images">
                                                            <a href="javascript:void(0)"><img src="assets/images/user/img-04.jpg" alt="" class="avatar-md img-thumbnail rounded-circle"></a>
                                                        </div>
                                                    </div><!--end col-->
                                                    <div class="col-lg-5">
                                                        <div class="candidate-list-content mt-3 mt-lg-0">
                                                            <h5 class="fs-19 mb-0"><a href="candidate-details.html" class="primary-link">Betty Richards</a> <span class="badge bg-success ms-1"><i class="mdi mdi-star align-middle"></i> 4.5</span></h5>
                                        ...
                                        <div class="candidate-list-box card mt-4">
                                            <div class="card-body p-4">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="candidate-list-images">
                                                            <a href="javascript:void(0)"><img src="assets/images/user/img-05.jpg" alt="" class="avatar-md img-thumbnail rounded-circle"></a>
                                                        </div>
                                                    </div><!--end col-->
                                                    <div class="col-lg-5">
                                                        <div class="candidate-list-content mt-3 mt-lg-0">
                                                            <h5 class="fs-19 mb-0"><a href="candidate-details.html" class="primary-link">Jeffrey Montgomery</a> <span class="badge bg-success ms-1"><i class="mdi mdi-star align-middle"></i> 4.9</span></h5>
                                        ...
                                        <div class="candidate-list-box card mt-4">
                                            <div class="card-body p-4">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="candidate-list-images">
                                                            <a href="javascript:void(0)"><img src="assets/images/user/img-06.jpg" alt="" class="avatar-md img-thumbnail rounded-circle"></a>
                                                        </div>
                                                    </div><!--end col-->
                                                    <div class="col-lg-5">
                                                        <div class="candidate-list-content mt-3 mt-lg-0">
                                                            <h5 class="fs-19 mb-0"><a href="candidate-details.html" class="primary-link">Milton Osborn</a> <span class="badge bg-danger ms-1"><i class="mdi mdi-star align-middle"></i> 2.5</span></h5>
                                        ...
                                        <div class="candidate-list-box card mt-4">
                                            <div class="card-body p-4">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="candidate-list-images">
                                                            <a href="javascript:void(0)"><img src="assets/images/user/img-07.jpg" alt="" class="avatar-md img-thumbnail rounded-circle"></a>
                                                        </div>
                                                    </div><!--end col-->
                                                    <div class="col-lg-5">
                                                        <div class="candidate-list-content mt-3 mt-lg-0">
                                                            <h5 class="fs-19 mb-0"><a href="candidate-details.html" class="primary-link">Harold Jordan</a> <span class="badge bg-success ms-1"><i class="mdi mdi-star align-middle"></i> 4.8</span></h5>
                                        ...
                                        <div class="candidate-list-box card mt-4">
                                            <div class="card-body p-4">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="candidate-list-images">
                                                            <a href="javascript:void(0)"><img src="assets/images/user/img-08.jpg" alt="" class="avatar-md img-thumbnail rounded-circle"></a>
                                                        </div>
                                                    </div><!--end col-->
                                                    <div class="col-lg-5">
                                                        <div class="candidate-list-content mt-3 mt-lg-0">
                                                            <h5 class="fs-19 mb-0"><a href="candidate-details.html" class="primary-link">MichaeL Drake</a> <span class="badge bg-warning ms-1"><i class="mdi mdi-star align-middle"></i> 3.9</span></h5>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="footer-item mt-4 mt-lg-0 me-lg-5">
                                    <h4 class="text-white mb-4">Emfob</h4>
                            ...
                            <div class="col-lg-2 col-6">
                                <div class="footer-item mt-4 mt-lg-0">
                                    ...
                                    <ul class="list-unstyled footer-list mb-0">
                                        ...
                                        <li><a href="blog.php"><i class="mdi mdi-chevron-right"></i> Blog</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <p class="text-white-50 text-center mb-0">
                                    <script>document.write(new Date().getFullYear())</script> &copy; Emfob - Job Listing Page
