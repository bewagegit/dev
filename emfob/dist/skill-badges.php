                            ...
                            <div class="card text-center position-relative skill-card">
                                <div class="card-header">
                                    ...
                                    <img src="<?php echo !empty($exam['image_path']) ? 
                                        BASE_URL_ADMIN.htmlspecialchars($exam['image_path']) : 
                                        BASE_URL_ADMIN.'assets/images/default-test-logo.png'; ?>" 
                                         alt="<?php echo htmlspecialchars($exam['title']); ?> Logo" 
                                         class="img-fluid logo-corner" 
                                         onerror="this.src='<?php BASE_URL_ADMIN; ?>assets/images/default-test-logo.png'"/>
                                </div>
                                <div class="card-body">
                                    <p class="mb-3">
