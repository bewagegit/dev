...
<!-- ============================================================== -->
                            ...
                            <div class="tab-content py-3">
                                <div class="tab-pane show active" id="chat">
                                    <div>
                                        <h5 class="fs-14 px-3 mb-3"><i class="mdi mdi-android-messages text-muted"></i>
                                            Recent</h5>
                                        <ul id="recentChatList" class="list-unstyled chat-list" data-simplebar style="max-height: 250px;overflow-y: scroll;">
										<?php
										if(count($messages) == 0){
											?>
											<li class="active">
                                ...
                                <div class="tab-pane" id="group">
                                    ...
                                    <ul class="list-unstyled chat-list" data-simplebar style="max-height: 250px;">
										...
										<li>
                                            <a href="javascript:void(0);" onclick="DisplayGroupChatMessage('<?php echo $val['id'] ?>','group')">
                            ...
                            <div class="px-lg-3" id="userChatMessageArea" style="display:none">
                                <div class="p-3 chat-input-section">
                                    <div class="row">
                                        ...
                                        <div class="col-auto" id="sendmessage">
                                            <button type="submit" onclick="sendMessage()"
                                                class="btn btn-primary chat-send w-md waves-effect waves-light"><span
                                                    class="d-none d-sm-inline-block me-2">Send</span> <i
                                                    class="mdi mdi-send"></i></button>
                                        </div>
										<div class="col-auto" id="sendgroupmessage">
                                            <button type="submit" onclick="sendGroupMessage()"
                                                class="btn btn-primary chat-send w-md waves-effect waves-light"><span
                                                    class="d-none d-sm-inline-block me-2">Send</span> <i
                                                    class="mdi mdi-send"></i></button>
                                        </div>
	...
	<script src="<?php echo BASE_URL; ?>js/chatscript.js"></script>
