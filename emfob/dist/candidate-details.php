...
<head>
    ...
    <meta charset="utf-8" />
    <title>Candidate Details | Emfob</title>
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-center"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div>
                                            <a class="dropdown-item" href="candidate-list.php">Candidate List</a>
                ...
                <ul class="header-menu list-inline d-flex align-items-center mb-0">
                    ...
                    <li class="list-inline-item dropdown">
                        <a href="javascript:void(0)" class="header-item" id="userdropdown" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <img src="assets/images/profile.jpg" alt="mdo" width="35" height="35"
                                    ...
                                    <div class="page-next">
                                        <nav class="d-inline-block" aria-label="breadcrumb text-center">
                                            <ol class="breadcrumb justify-content-center">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page"> Candidate
                                                    Details </li>
                                            </ol>
                                        </nav>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card side-bar">
                                    ...
                                    <div class="candidate-profile-overview  card-body border-top p-4">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-primary btn-hover w-100 mt-2"><i
                                                    class="uil uil-import"></i> Download CV</a>
                                        </div>
                                        <ul
                                            class="list-inline d-flex justify-content-between align-items-center mb-0 mt-2">
                                    ...
                                    <div class="card-body p-4 border-top">
                                        ...
                                        <div>
                                            <span class="badge bg-success-subtle text-success fs-13 mt-1">User Interface
                                                Design</span>
                                            <span class="badge bg-success-subtle text-success fs-13 mt-1">Web
                                                Design</span>
                                            <span class="badge bg-success-subtle text-success fs-13 mt-1">Responsive
                                                Design</span>
                                            <span class="badge bg-success-subtle text-success fs-13 mt-1">Mobile App
                                                Design</span>
                                            <span class="badge bg-success-subtle text-success fs-13 mt-1">UI
                                                Design</span>
                                        </div>
                                    </div><!--end card-body-->
                                    ...
                                    <div class="card-body p-4 candidate-personal-detail">
                                        <div>
                                            ...
                                            <p class="text-muted mb-2">Very well thought out and articulate
                                                ...
                                                platform.</p>
                                            <p class="text-muted mb-0">As a highly skilled and successfull product
                                                development and design specialist with more than 4 Years of My
                                                experience lies in successfully conceptualizing, designing, and
                                                modifying consumer products specific to interior design and home
                                                furnishings.</p>
                                        </div>
                                        <div class="candidate-education-details mt-4 pt-3">
                                            ...
                                            <div class="candidate-education-content mt-4 d-flex">
                                                <div class="circle flex-shrink-0 bg-primary-subtle text-primary"> B
                                                </div>
                                                <div class="ms-4">
                                            ...
                                            <div class="candidate-education-content mt-4 d-flex">
                                                <div class="circle flex-shrink-0 bg-primary-subtle text-primary"> M
                                                </div>
                                                <div class="ms-4">
                                                    <h6 class="fs-16 mb-1">MCA - Master of Computer Application</h6>
                                                    <p class="mb-2 text-muted">International University - (2010 - 2012)
                                                    </p>
                                                    <p class="text-muted">There are many variations of passages of
                                                        available, but the majority alteration in some form. As a highly
                                                        skilled and successfull product development and design
                                            ...
                                            <div class="candidate-education-content mt-4 d-flex">
                                                <div class="circle flex-shrink-0 bg-primary-subtle text-primary"> D
                                                </div>
                                                <div class="ms-4">
                                                    <h6 class="fs-16 mb-1">Design Communication Visual</h6>
                                                    <p class="text-muted mb-2">International University - (2012-2015)
                                                    </p>
                                                    <p class="text-muted">There are many variations of passages of
                                                        available, but the majority alteration in some form. As a highly
                                                        skilled and successfull product development and design
                                        ...
                                        <div class="candidate-education-details mt-4 pt-3">
                                            ...
                                            <div class="candidate-education-content mt-4 d-flex">
                                                <div class="circle flex-shrink-0 bg-primary-subtle text-primary"> W
                                                </div>
                                                <div class="ms-4">
                                            ...
                                            <div class="candidate-education-content mt-4 d-flex">
                                                <div class="circle flex-shrink-0 bg-primary-subtle text-primary"> P
                                                </div>
                                                <div class="ms-4">
                                                    <h6 class="fs-16 mb-1">Project Manager</h6>
                                                    <p class="mb-2 text-muted">Emfob Technology Pvt.Ltd - (Pressent)</p>
                                        ...
                                        <div class="mt-4 pt-3">
                                            ...
                                            <div class="d-sm-flex align-items-top mt-4">
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-circle avatar-md img-thumbnail"
                                                        src="assets/images/user/img-02.jpg" alt="img">
                                                </div>
                                                <div class="flex-grow-1 ms-sm-3">
                                                    <div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="inputcoment" rows="3"
                                                            placeholder="Add your review"></textarea>
                                                    </div>
                                                </div><!--end col-->
                                            </div><!--end row-->
                                            <div class="text-end">
                                                <button type="submit" class="btn btn-primary btn-hover">Submit Review <i
