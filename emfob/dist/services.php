...
include "sections/signup-modal.php"; ?>
<!-- END SIGN-UP MODAL -->
                        ...
                        <div class="card service-box mt-4">
                            <div class="card-body p-4">
                                ...
                                <div class="learn-more">
                                    <a href="javascript:void(0)" class="form-text text-primary">Learn More <i
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card service-box mt-4">
                            <div class="card-body p-4">
                                ...
                                <div class="mt-4">
                                    <h5>Temp Search</h5>
                                    <p class="text-muted">It seems that only fragments of the original text remain in
                                        the Lorem Ipsum texts used fragments today.</p>
                                    <div class="learn-more">
                                        <a href="javascript:void(0)" class="form-text text-primary">Learn More <i
                                                class="uil uil-angle-right-b"></i></a>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card service-box mt-4">
                            <div class="card-body p-4">
                                ...
                                <div class="mt-4">
                                    <h5>For Agencies</h5>
                                    <p class="text-muted">At missed advice my it no sister. Miss told ham dull knew see
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card service-box mt-4">
                            <div class="card-body p-4">
                                ...
                                <div class="mt-4">
                                    <h5>Quick Support</h5>
                                    <p class="text-muted">Designers have a lot of tools to make a story more intersting.
                                        You can align your image to the leftcenter with a caption.</p>
                                    <div class="learn-more">
                                        <a href="javascript:void(0)" class="form-text text-primary">Learn More <i
                                                class="uil uil-angle-right-b"></i></a>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card service-box mt-4">
                            <div class="card-body p-4">
                                ...
                                <div class="mt-4">
                                    <h5>Bookmark Jobs</h5>
                                    <p class="text-muted">Becomes an interactive story that can engage users. Designers
                                        have a lot of tools to make a story more intersting.</p>
                                    <div class="learn-more">
                                        <a href="javascript:void(0)" class="form-text text-primary">Learn More <i
                                                class="uil uil-angle-right-b"></i></a>
                                    </div>
                        ...
                        <div class="card service-box mt-4">
                            <div class="card-body p-4">
                                ...
                                <div class="mt-4">
                                    ...
                                    <p class="text-muted">A business consulting agency is involved in the planning,
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mt-4">
                                    ...
                                    <p class="text-muted">The most important aspect of beauty was, therefore, an
                                        inherent part of an object, rather than something.</p>
                                    <div class="learn-more">
                                        <a href="javascript:void(0)" class="form-text text-primary">Learn More <i
                                                class="uil uil-angle-right-b"></i></a>
                                    </div>
                        ...
                        <div class="card service-box mt-4">
                            <div class="card-body p-4">
                                ...
                                <div class="mt-4">
                                    ...
                                    <p class="text-muted">This response is important for our ability to learn from
